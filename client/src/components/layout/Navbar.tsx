...
import { Cpu, Bell, Shield, Zap, User } from 'lucide-react';
          ...
          {user ? (
            <div className="flex items-center gap-3 border-l border-slate-800/80 pl-4">
              ...
              {onLogout && (
                <button
                  onClick={onLogout}
                  className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-800 hover:text-slate-200 transition-colors text-xs font-medium"
                  title="Logout"
                >
                  Logout
                </button>
            ...
            <div className="flex items-center gap-2 border-l border-slate-800/80 pl-4">
              <button className="rounded-xl bg-indigo-600/90 hover:bg-indigo-500 px-3.5 py-1.5 text-xs font-semibold text-white shadow-md shadow-indigo-600/20 transition-all">
                Sign In
              </button>
            </div>
          )}
